  ...
  return (
    <>
      ...
      <h1>
        ...
        drown in it. You're fucking dead, kiddo. On May 24th, 2012, an anonymous
        user submitted a thread to the /pasta/[1] board, claiming he had created
        the original copypasta two to three years prior (shown below).
      </h1>
    </>
  );
};
